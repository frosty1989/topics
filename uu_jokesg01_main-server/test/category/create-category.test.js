...
describe("Test createCategory command - A3", () => {
  test("uuObject Category with the specified name already exists", async () => {
    ...
    try {
      let category1 = await TestHelper.executePostCommand("createCategory", {
        name: "test name",
        desc: "test desc",
        glyphicon: "http://test.jpg"
      });

      let category2 = await TestHelper.executePostCommand("createCategory", {
        name: "test name",
        desc: "test desc",
        glyphicon: "http://test.jpg"
      });
